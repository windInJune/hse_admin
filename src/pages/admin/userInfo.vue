...
export default {
  ...
  created() {
    this.addBigBForm.userName = localStorage.getItem("userNameHse");
    this.addBigBForm.systemName = localStorage.getItem("systemNameHse");
  },
  components: {
    "my-upload": myUpload
  },
        ...
        if (
          ...
          this.$http
            .post(
              ...
              {
                userId: localStorage.getItem("userIdHse"),
            ...
            .then(res => {
              if (res.body.status == 200) {
                ...
                localStorage.setItem("userNameHse", this.addBigBForm.userName);
                localStorage.setItem("systemNameHse", this.addBigBForm.systemName);
              } else {
                this.$message({
